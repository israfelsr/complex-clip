...
```
python main_aro.py --model-name longclip
python main_retrieval.py --model-name longclip
```
Expected checkpoint: longclip-B.pt in root dir


DCI

```
python dci_run_aro.py
python dci_run_retrieval.py --adapter <local of hf path>
```

DAC

```
python dac_run_aro.py --lora 4 --resume DAC_LLM_cp.pt
python dac_run_retrieval.py --lora 4 --resume DAC_LLM_cp.pt
```
