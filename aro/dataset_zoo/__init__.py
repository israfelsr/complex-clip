...
def get_dataset(
    ...
    **kwargs,
    ...
    if dataset_name == "VG_Relation":
        ...
        return get_visual_genome_relation(
        ...
        return get_visual_genome_attribution(
            image_preprocess=image_preprocess,
            text_perturb_fn=text_perturb_fn,
            image_perturb_fn=image_perturb_fn,
            download=download,
    ...
    elif dataset_name == "Urban1k_Retrieval":
        from .retrieval import get_urban1k_retrieval

        return get_urban1k_retrieval(
            image_preprocess=image_preprocess, download=download, *args, **kwargs
        )
    else:
