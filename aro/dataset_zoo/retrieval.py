...
class Urban1k_Retrieval(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        """
        Urban1k dataset for retrieval.
        image_preprocess: image preprocessing function
        root_dir: The directory of the coco dataset. This directory should contain a json file.
        max_words: Cropping the caption to max_words.
        image_perturb_fn: image perturbation function for patch permutation experiments.
        """

        if not os.path.exists(root_dir):
            print("Directory for Urban1k could not be found!")

        self.annotation = json.load(open(os.path.join(root_dir, "urban1k.json"), "r"))
        self.image_preprocess = image_preprocess
        self.image_perturb_fn = image_perturb_fn
        self.root_dir = root_dir
    ...
    def evaluate_scores(self, scores):
        ...
        print(f"Urban1k Retrieval results across {scores_i2t.shape} samples. ")
        prec_at_1 = AverageMeter()
        prec_at_5 = AverageMeter()
...
class sDCI_Retrieval(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        if not os.path.exists(root_dir):
            print("Directory for sDCI could not be found!")

        self.annotation = load_from_disk(root_dir)
        self.image_preprocess = image_preprocess
        self.image_perturb_fn = image_perturb_fn
        self.root_dir = root_dir
    ...
    def evaluate_scores(self, scores):
        ...
        print(f"SDCI Retrieval results across {scores_i2t.shape} samples. ")
        prec_at_1 = AverageMeter()
        prec_at_5 = AverageMeter()
...
class DOCCI_Retrieval(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        if not os.path.exists(root_dir):
            print("Directory for DOCCI could not be found!")
    ...
    def evaluate_scores(self, scores):
        ...
        print(f"DOCCI Retrieval results across {scores_i2t.shape} samples. ")
        prec_at_1 = AverageMeter()
        prec_at_5 = AverageMeter()
...
class IIW_Retrieval(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        """
        IIW dataset for retrieval.
        image_preprocess: image preprocessing function
        root_dir: The directory of the iiw dataset. This directory should contain a json file.
        max_words: Cropping the caption to max_words.
        image_perturb_fn: image perturbation function for patch permutation experiments.
        """

        if not os.path.exists(root_dir):
            print("Directory for IIW could not be found!")
    ...
    def evaluate_scores(self, scores):
        ...
        print(f"IIW Retrieval results across {scores_i2t.shape} samples. ")
        prec_at_1 = AverageMeter()
        prec_at_5 = AverageMeter()
...
def get_urban1k_retrieval(
    image_preprocess, max_words=1500, download=False, root_dir=URBAN_ROOT, split="test"
):
    dataset = Urban1k_Retrieval(
        root_dir=root_dir,
        image_preprocess=image_preprocess,
        max_words=max_words,
        download=download,
...
def get_sdci_retrieval(
    image_preprocess, max_words=1500, download=False, root_dir=SDCI_ROOT
):
    dataset = sDCI_Retrieval(
        root_dir=root_dir,
        image_preprocess=image_preprocess,
        max_words=max_words,
        download=download,
