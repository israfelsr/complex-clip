...
def run_aro_evals(model: CLIPModel, processor: CLIPProcessor):
    ...
    flickr_order_dataset = Flickr30k_Order(image_preprocess=processor.image_processor, split='test', root_dir=FLICKR_DIR)
...
def run_aro_on_lora(processor, base_clip_model, lora_weight_path):
...
if __name__ == '__main__':
    ...
    run_aro_on_lora(clip_processor, clip_model, "output/1.0-2.0-1.0_lr1e-3-ckpt-522")
